...
```bash
pip install "fawp-index==1.1.6"              # core
pip install "fawp-index[dashboard]==1.1.6"   # + Streamlit dashboard
pip install "fawp-index[fast]==1.1.6"        # + Numba JIT (5-15x faster scans)
pip install "fawp-index[all]==1.1.6"         # everything
```
