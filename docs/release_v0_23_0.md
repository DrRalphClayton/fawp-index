...
```bash
pip install "fawp-index==0.27.0"              # core
pip install "fawp-index[dashboard]==0.27.0"   # + Streamlit dashboard
pip install "fawp-index[fast]==0.27.0"        # + Numba JIT (5-15x faster scans)
pip install "fawp-index[all]==0.27.0"         # everything
```
