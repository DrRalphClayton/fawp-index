...
fig.text(.5,.01,"fawp-index v1.1.4 · doi:10.5281/zenodo.18673949",ha="center",color=MUTED,fontsize=7)
...
fig2.text(.5,.01,"ERA5 via Open-Meteo · fawp-index v1.1.4 · fawp-scanner.info",ha="center",color=MUTED,fontsize=7)
plt.tight_layout(pad=1.2)
