...
- docs: auto-update CHANGELOG for v3.7.27
- release v3.7.27: 61-check debug pass — all clean
- docs: auto-update CHANGELOG for v3.2.0
- feat v3.2.0: URL sharing, portfolio mode, example datasets, LERI latent CLI, phase diagram, correlation matrix, leaderboard push/list CLI
- feat v2.9.0: real-time seismic magnitude alerts with threshold slider and dedup
...
- `dashboard/requirements.txt` pinned to `fawp-index==2.8.0` so Render pulls the correct patched version
